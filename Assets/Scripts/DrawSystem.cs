...
public class DrawSystem : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        //drawData.drawVariables.variablesData.whiteBoardButton.onClick.AddListener(checkIfWhiteBoardIsClicked);
        //drawData.drawVariables.variablesData.mouseLineRenderer = GetComponent<LineRenderer>();
    }
    ...
    private void checkIfWhiteBoardIsClicked()
    {
        //drawData.drawVariables.variablesData.drawData.drawVariables.variablesData.whiteBoardButtonIsClicked = true;
    }
    ...
    private bool drawHasStarted()
    {
        ...
        if (click == true)
        {
            ...
            mousePos.z = 20;
            //mousePos.z = Random.Range(19.5f, 20f);
